...
$installTest = Join-Path $projectRoot "tests/test_install.ps1"
$docsTest = Join-Path $projectRoot "tests/test_docs.ps1"
...
Assert-PowerShellSyntax $installTest
Assert-PowerShellSyntax $docsTest
